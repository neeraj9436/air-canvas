...
cv2.createTrackbar("Upper Hue", "Color detectors", 137, 180,setValues)
cv2.createTrackbar("Upper Saturation", "Color detectors", 255, 255,setValues)
cv2.createTrackbar("Upper Value", "Color detectors", 138, 255,setValues)
cv2.createTrackbar("Lower Hue", "Color detectors", 44, 180,setValues)
cv2.createTrackbar("Lower Saturation", "Color detectors", 131, 255,setValues)
